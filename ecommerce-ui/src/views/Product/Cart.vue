<template>
  <div class="container">
    ...
    >
      ...
      <div class="col-md-3 embed-responsive embed-responsive-16by9">
        <img
          ...
          alt=""
          class="w-90 card-image-top embed-responsive-item"
    ...
    <div class="total-cost pt-2 text-right">
      <h5>Total : {{ formattedTotalCost }}</h5>
      <button class="btn btn-primary confirm" @click="checkout">
        Confirm order
      </button>
    </div>
  </div>
...
export default {
  ...
  computed: {
    formattedTotalCost() {
      return this.totalCost.toLocaleString("en-US", {
        style: "currency",
        currency: "USD",
      });
    },
